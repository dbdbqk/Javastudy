...
public class MainClass {
	...
	*/
	...
	public static void ex01()  { // FileWriter
	...
	public static void ex02() { // 스트림 자동으로 닫아주는 try 문
	...
	public static void ex03() { // BufferedWriter (보조스트림)
	...
	public static void ex04() {
		...
		try(BufferedWriter bw = new BufferedWriter(new FileWriter(file))){ // 이게 일반적
