...
public class MainCalss {
	...
	public static void main(String[] args) {
		...
		System.out.println("주소 : " + user1.addr.postcoad + " " + user1.addr.roadAddress + "(" + user1.addr.jibunAddress + ")");
		...
		System.out.println("주소 : " + user2.addr.postcoad + " " + user2.addr.roadAddress + "(" + user2.addr.jibunAddress + ")");
