...
public class User {
	...
	/*
		...
		2. default		: 동일한 패키지에서만 접근 할 수 있다.
		3. protected	: 동일한 패키지 또는 상속 관계의 클래스에서만 접근 할 수 있다. 
		4. public		: 누구나 접근 할 수 있다.
	*/
	...
	*/
	...
	// 필드
	private String id; // 앞으로 모든 수업에 필드는 특별한 사유가 없는 이상 100% private다.
	private String pw;
	private boolean isVip;
	
	
	
	// 메소드    * 이 메소드는 꼭 공부 하기 * Source 메뉴에 자동으로 만드는 기능 있음
	public String getId() {
		return id;
	}
