...
public class MainClass {
	...
	/*
		...
		4. Object 타입으로 저장된 객체는 Object 클래스의 메소드만 호출할 수 있으므로 다시 원래 객체의 타입으로 캐스팅해서 사용해야 한다. // 꺼내 쓸 떄는 캐스팅 해야함
	*/
	
	/*
		Object 클래스의 주요 메소드
		1. equals
			1) 동등 비교할 때 사용하는 메소드       (오브젝트에 equals는 참조값을 비교한다)
			2) 동등 비교하는 객체들의 참조값을 비교함
	...
	*/
	...
	public static void ex02() {
		...
		if(person1.equals(person2)) {  // 오브젝트에 equals는 참조값을 비교함. 내용이 같더라도 다르다고 인식 함
