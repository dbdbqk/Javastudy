...
public class Ex01_String {
	...
	*/
	...
	public static void stringObject() {
		...
		// 문자열 객체는 언제나 새로 생성된다.(리터럴과 달리 최적화 되지 않는다.)
	...
	*/
	...
	public static void length() {
		...
		String str = "Hello\nWorld";
		int length = str.length(); // 조심해야 할 것 배열의 길이는 arr.length 이지만 문자의 길이는 str.length()로 사용 해야함 꼭 주의
	...
	public static void lastIndexsOf() {
	...
	public static void replace() {
		...
		// replaceAll
		// 정규식 패턴(Regular Expression)을 만족하는 변환한 결과를 반환
	...
	public static void format() {
		...
		System.out.println(String.format("%x", number));	//	% : 16진수로 표시하시오.(0~9, a, b, c, d, e, f)
		System.out.println(String.format("%X", number));	//	% : 16진수로 표시하시오.(0~9, A, B, C, D, E, F)
