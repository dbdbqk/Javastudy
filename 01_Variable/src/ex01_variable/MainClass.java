...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		// 문자 타입(Character) : 1글자만 문자타입 2개이상은 문자타입 아님
		char ch1 = 'A';
		char ch2 = '홍';
		char ch3 = '\n'; // 라인 피드 - 줄 바꿈
		char ch4 = '\t'; // 탭
		char ch5 = '\''; // 작은따옴표 
		char ch6 = '\"'; // 큰따옴표
		System.out.println(ch1); // 컨트롤 알트 방향키 아래 해당 줄 복사
		...
		// 정수 타입
		int age = 46;
		long money = 10000000000L; // 21억4천7백만 이상일 경우는 long
